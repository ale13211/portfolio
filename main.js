...
import { createKeyboard } from "./keyboard.js?v=5";
  ...
  function showSkill(skill) {
    ...
    callout.style.setProperty("--key", skill.color === "black" ? "#CBD5E1" : (KEY_COLORS[skill.color] || "#fff"));
  ...
  // Respaldo: en iPhone el scroll con inercia puede avisar tarde.
  ...
  async function initKeyboard() {
    ...
    keyboard = createKeyboard({
      ...
      // Cuánto está corrida la sección Skills respecto de la pantalla (0 = alineada).
      getSkillsOffset: () => skillsSection.getBoundingClientRect().top / window.innerHeight,
    });
    if (!keyboard) {
